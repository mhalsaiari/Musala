...
public class ExtentManager {
    ...
    static {
        ...
        reportPath = System.getProperty("user.dir") + "/extent-reports/" + reportFileName;
        ...
        EXTENT_REPORTS.setSystemInfo("Author", "Mohammed Alsaiari");
        EXTENT_REPORTS.setSystemInfo("Env", "Test");
